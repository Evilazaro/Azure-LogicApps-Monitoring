...
(!(function (e, t) {
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            we.test(e.type) && e.click && l(e, "input") && Ie(e, "click", n),
            !1
          );
        },
        trigger: function (e) {
          e = this || e;
          return (
            we.test(e.type) && e.click && l(e, "input") && Ie(e, "click"),
            !0
          );
        },
        _default: function (e) {
  ...
  (T.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (a = j(c, "script")).length && Ee(a, !d && j(e, "script")),
        c
      );
    },
  ...
  $(document).ready(function () {
    ...
    function o(e) {
      ...
      throw (
        console.warn(t),
        new Error("No code block found for this button.")
      );
    }
    var e;

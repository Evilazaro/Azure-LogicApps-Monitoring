...
[![Logic Apps](https://img.shields.io/badge/Azure-Logic%20Apps-0078D4?logo=microsoftazure)](https://azure.microsoft.com/products/logic-apps)
...
[![Build](https://img.shields.io/github/actions/workflow/status/Evilazaro/Azure-LogicApps-Monitoring/ci-dotnet.yml?label=CI&logo=githubactions)](https://github.com/Evilazaro/Azure-LogicApps-Monitoring/actions/workflows/ci-dotnet.yml)
[![Aspire](https://img.shields.io/badge/.NET%20Aspire-13.1.0-512BD4?logo=dotnet)](https://learn.microsoft.com/dotnet/aspire/)
[![Security](https://img.shields.io/badge/Security-Managed%20Identity-success?logo=microsoftazure)](docs/architecture/06-security-architecture.md)

> [!NOTE]
> **Target Audience**: Platform Engineers, DevOps Engineers, Cloud Architects, and .NET Developers building enterprise observability solutions on Azure.
>
...
| Section                                     | Description                              |
| ------------------------------------------- | ---------------------------------------- |
| [✨ Key Features](#-key-features)           | Core capabilities and value propositions |
| [🏗️ Architecture](#️-architecture-overview)  | System design and Azure services used    |
| [📋 Prerequisites](#-prerequisites)         | Required tools and Azure subscription    |
...
| [🔧 Local Development](#-local-development) | Running locally with .NET Aspire         |
...
> [!TIP]
> 📖 **Detailed Architecture**: See [docs/architecture/README.md](docs/architecture/README.md) for complete TOGAF-aligned documentation including TOGAF-aligned business, data, application, and technology architecture.

<div align="right">

[⬆️ Back to Top](#-azure-logic-apps-monitoring-solution)
...
> [!TIP]
> Use `azd monitor --overview` to open the Azure Portal dashboard for your deployed resources.
...
> [!WARNING]
> All pull requests must pass the CI pipeline checks before merging. Run `dotnet test` locally to verify your changes.
...
| ------------------------------------------------------------- | ------------------------------------------------- |
| [Architecture Overview](docs/architecture/README.md)          | Complete TOGAF-aligned architecture documentation |
| [DevOps Guide](docs/devops/README.md)                         | CI/CD pipeline documentation                      |
| [Developer Experience](docs/hooks/README.md)                  | azd lifecycle automation scripts                  |
| [IP Security Configuration](docs/IP-SECURITY-RESTRICTIONS.md) | Network security setup guide                      |

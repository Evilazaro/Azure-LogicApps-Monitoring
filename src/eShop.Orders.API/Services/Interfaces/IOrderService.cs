...
public interface IOrderService
{
    ...
    /// <summary>
    /// Deletes multiple orders asynchronously in a batch operation.
    /// </summary>
    /// <param name="orderIds">The collection of order IDs to delete.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the operation.</param>
    /// <returns>The number of successfully deleted orders.</returns>
    Task<int> DeleteOrdersBatchAsync(IEnumerable<string> orderIds, CancellationToken cancellationToken = default);
}
...
- [Required Environment Variables](#️-required-environment-variables)
  - [How azd Sets These Variables](#how-azd-sets-these-variables)
- [Usage](#-usage)
...
- [Parameters](#-parameters)
  - [`-Force` (PowerShell) / `--force` (Bash)](#-force-powershell----force-bash)
  - [`-WhatIf` (PowerShell) / `--dry-run` (Bash)](#-whatif-powershell----dry-run-bash)
  - [`-Confirm`](#-confirm)
  - [`-Verbose` (PowerShell) / `--verbose` (Bash)](#-verbose-powershell----verbose-bash)
...
| Aspect                  | Details                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Version**             | 2.0.1 (PowerShell: 2025-12-29, Bash: 2025-12-29)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

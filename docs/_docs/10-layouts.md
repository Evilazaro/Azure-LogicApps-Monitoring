...
_New in v4.26.0_: If you have multiple sidebar navs defined and want to include more than one on a page, the sidebar nav can also be a list.
...
$buttoncolors:
  ...
  (linkedin, $linkedin-color), (reddit, $reddit-color);
```

...
| Place Orders Batch       | Parallel processing of multiple orders with semaphore-controlled concurrency | [OrderService.cs](../../src/eShop.Orders.API/Services/OrderService.cs#L140-L190)                                     | 0.95       | 4 - Measured |

...
| **Confidence**   | 0.99                                                                                                                                         |
| **Maturity**     | 4 - Measured                                                                                                                                 |
| **Dependencies** | Order Placement (C1), Event Messaging Service (BS3), Order Processing Callback (E4)                                                          |
...
| **Confidence**   | 0.98                                                                                                       |
| **Maturity**     | 4 - Measured                                                                                               |
| **Dependencies** | Domain Validation (BR1-BR7), Order Data Repository (BS5), Event Messaging Service (BS3)                    |
...
| **Confidence**   | 0.97                                                                                                                                        |
| **Maturity**     | 4 - Measured                                                                                                                                |
| **Dependencies** | Order Placement (C2), Duplicate Order Prevention (BR6)                                                                                      |
...
| **Confidence**   | 0.96                                                                                                          |
| **Maturity**     | 3 - Defined                                                                                                   |
| **Dependencies** | Order Data Repository (BS5), Order (BO1), OrderProduct (BO2)                                                  |
...
| **Confidence**   | 0.95                                                                                                         |
| **Maturity**     | 3 - Defined                                                                                                  |
| **Dependencies** | Order Data Repository (BS5), Order (BO1)                                                                     |
...
| **Confidence**   | 0.95                                                                                                          |
| **Maturity**     | 3 - Defined                                                                                                   |
| **Dependencies** | Automated Order Processing (C1), Recurrence Trigger (E5)                                                      |
| **KPIs**         | Not detected                                                                                                  |
...
| **Confidence**   | 0.94                                                                                                        |
| **Maturity**     | 3 - Defined                                                                                                 |
| **Dependencies** | Order Management API (BS1), Customer / End User (R1), Operations Team (R2)                                  |
| **KPIs**         | Not detected                                                                                                |
...
| **Processes**          | Place Order Flow (P2), OrdersPlacedProcess Workflow (P1), OrdersPlacedCompleteProcess Workflow (P3)                                                                            |
...
See Section 2.6 for summary. No additional specifications detected in source files. No explicit organizational business function boundaries were identified in the codebase. Recommend establishing functional ownership for: Order Management Operations, Platform Engineering, Customer Experience.

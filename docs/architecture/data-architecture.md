...
| Classification                 | Fill (100-200) | Stroke (600) | Text (900) | Applied |
| ------------------------------ | -------------- | ------------ | ---------- | ------- |
| System of Record (SoR) 💾      | #bbdefb        | #1e88e5      | #0d47a1    | ✅      |
| System of Reference (SoRef) 📚 | #b2dfdb        | #00897b      | #004d40    | ✅      |
| System of Engagement (SoE) ⚡  | #ffe082        | #ffb300      | #e65100    | ✅      |
| System of Insight (SoI) 📊     | #d1c4e9        | #5e35b1      | #311b92    | ✅      |
| External 🌐                    | #cfd8dc        | #546e7a      | #263238    | ✅      |
...
- Diagram Syntax: ✅ All diagrams from Phase 2 collection
...
- src/eShop.Orders.API/data/OrderMapper.cs
...
- **L4 Analysis & Visualization:** No Azure dashboards or workbooks defined in IaC
- **L5 Action & Alerting:** No alert rules or action groups defined in IaC
- **Data Retention Policies:** Application-level retention not explicitly configured in code

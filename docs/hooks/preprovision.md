...
| --------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **2.3.1** | 2026-01-16 | • Added preference backup/restore pattern in PowerShell<br/>• Added `-CommandType Application` to `Get-Command` calls for external commands<br/>• Added IFS protection in Bash                                                                      |
